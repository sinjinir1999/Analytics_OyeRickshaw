...
select mp.zone_new, count(distinct case when rank>=4 then referree_mobile end) as Active_Partners,
count(distinct case when mp.onboarding_date between '2021-07-26' and '2021-08-25' and rank>=4 then mobile end) New_Merchant_Partners_acquired
from
