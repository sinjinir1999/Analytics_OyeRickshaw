select zone_new,
count(distinct case when onboarding_date <= '2021-07-31' and count_of_leads >= 3 and months = 8 and months != 7 and referral_count>=4 then referree_mobile end) as total_leads
from
(
